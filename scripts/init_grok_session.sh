...
GROK_PARENT="${PRINTSTACK_GROK_WORKTREES:-${HOME}/.grok/worktrees/mini-projects-printstack}"
...
Examples:
  ...
  /home/derek/Sync/mini_projects/printstack/scripts/init_grok_session.sh

  init_grok_session.sh ~/.grok/worktrees/mini-projects-printstack/<session-id>
EOF
}
...
if [[ "$(readlink -f "$REPO_ROOT")" == "$(readlink -f "$SYNC_REPO")" ]]; then
  ...
  warn "Init is intended for ~/.grok/worktrees/mini-projects-printstack/<session-id>/"
...
cat <<'EOF'
================================================================================
Using Grok / Cursor agents efficiently (printstack)
================================================================================
